...
class FakeDriver(driver.ComputeDriver):
	...
	self.conn = ec2.connect_to_region("us-west-2", aws_access_key_id="AKIAI46VRJS7F3OWVQXQ", aws_secret_access_key="eRdkpwP4wFCCgdXndm/m06XSuIHZv+DI9lsgmOEL")
        self.instances = {}
	...
	self.conn.run_instances('ami-def297ee', instance_type='t1.micro')
